<template>
  <v-container fluid class="hero-section">
    ...
    <v-img
      :src="require('@/assets/fitness_tribe/shape_ft_2.png')"
    ...
    <v-row align="center" justify="space-between" class="hero-row">
      ...
      <v-col cols="12" md="6" class="text-section">
        <div class="logo">
          <v-img
            :src="require('@/assets/fitness_tribe/fitness_tribe_logo.png')"
      ...
      <v-col cols="12" md="6" class="image-section">
        <div class="app-screens">
          <v-img
            :src="require('@/assets/fitness_tribe/fitnessTribePhone.png')"
...
.hero-section {
  ...
  padding: 20px;
  position: relative; /* For absolute positioning of corner images */
  padding-left: 50px;
  border-radius: 3px;
  overflow: hidden;
  margin-bottom: 50px;
...
.screenshot-main {
  transform: rotate(-5deg); /* Tilt the main image */
}
...
@media (max-width: 768px) {
  ...
  .corner-image {
    width: 100px; /* Smaller corner images on mobile */
    visibility: hidden;
  }
}
</style>
